...
# Event Data State matching Reference Image
...
with col_head1:
    # Logo button - Returns to Home Screen
...
with col_head3:
    # Only Settings button in top-right area
...
if st.session_state.page == "home":
    ...
    with col_box1:
        # Full Clickable Big Card 1: Dashboard
    ...
    with col_box2:
        # Full Clickable Big Card 2: AI Report
...
# ================= PAGE 2: DASHBOARD (Matching Reference Image) =================
    ...
    # 1. Event Input Bar (Horizontal Parameter Badges matching Image)
    ...
    # Display Top Parameter Bar summary pills
    st.markdown(f"""
    ...
    if not st.session_state.design_generated:
        ...
        # Main Dashboard Layout Grid matching Reference Image
        col_map, col_heat, col_eval = st.columns([5, 3, 4])

        # 1. Map Panel (Digital Twin Layout)
        with col_map:
            st.markdown("""
            ...
            # Create Interactive Plotly Digital Twin Map
            fig_map = go.Figure()

            # Outdoor Green Lawn Ground
            fig_map.add_shape(
        ...
        with col_heat:
            ...
            # Simulated Crowd Heatmap distribution
            x_h = np.random.uniform(10, 90, 200)
            y_h = np.random.uniform(10, 90, 200)
            # Dense near Stage (50, 85) & Food zone (25, 55)
        ...
        # 3. AI Evaluation Scores & Improvement Recommendations
        with col_eval:
        ...
        # Dynamic Placement Rationale Section (When selecting zones)
        ...
        # 4. Interactive AI Chat Drawer for Custom Adjustments
        ...
        # Lower Grid Section matching Reference Image Bottom
        col_bot1, col_bot2, col_bot3 = st.columns([4, 5, 3])

        with col_bot1:
            st.markdown("#### ⚖️ 설계 전 / 후 비교")
            st.markdown("""
            <div style="font-size:13px; background:#ffffff; padding:12px; border-
