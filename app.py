...
FACILITIES = {
    ...
    "food": {
        ...
        "reason": "서쪽 측면에 독립 배치하여 유가공/조리 연기 확산을 방지하고 메인 공연 관람 동선과 유입 인원이 엉키지 않도록 분리했습니다."
    },
    "booth": {
        "name": "체험 부스",
        "icon": "🛍️",
        ...
        "reason": "주 출입구 진입 직후 인근 서북쪽 길목에 배치하여 행사 초반 참여도를 높이고 대기 인원 정체를 완화하도록 설계했습니다."
    },
    "rest": {
        "name": "휴게 공간",
        "icon": "🏕️",
        ...
        "reason": "행사장 중앙 보행 축에 위치시켜 무대 관람과 푸드존 이용객 모두 신속하게 쉬어갈 수 있는 최적의 오아시스 존을 형성했습니다."
    },
    "medical": {
        "name": "응급 의료 센터",
        "icon": "🚑",
        ...
        "reason": "구급차 전용 진출입로가 확보된 동쪽 외곽 진입로 옆에 배치하여 긴급 이송 시 최단 진출 시간을 보장합니다."
    },
    "info": {
        "name": "정보 센터",
        "icon": "ℹ️",
        ...
        "reason": "남쪽 주 출입구 바로 전면에 위치시켜 입장객 길 안내 및 잃어버린 물품 접수를 즉시 처리할 수 있도록 배치했습니다."
    },
    "toilet": {
        "name": "화장실",
        "icon": "🚻",
        ...
        "reason": "동쪽 측면 배관 인근에 위치시켜 혼잡도를 분산하고 상하수도 설비 연결 효율성을 높였습니다."
    },
    "exit": {
        "name": "비상구 및 출입구",
        "icon": "🚪",
        ...
        "reason": "남쪽 정문 출입구 및 동/서측 비상 탈출로를 일직선상에 비상 연결하여 비상상황 시 인파 병목 없는 대피를 유도합니다."
    }
}
...
# -------------------------------------------------------------------
    ...
    if not st.session_state['digital_twin_generated']:
        ...
        with col_main_left:
            st.markdown("### 🌐 행사장 배치도 (디지털 트윈 기반 3D 뷰어)")
            
            # PyDeck 3D Isometric 공간 시각화
        ...
        with col_main_right:
            ...
            current_fac = FACILITIES[selected_key]
